...
<div class="container py-4 color-kernjang">
    <h2 class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2" style="color: #6d0808ff">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold fs-5" style="color: #6d0808ff">
                                Rp {{ number_format($grandTotal, 0, ',', '.') }}
                            </span>
                        </div>
                        <a href="{{ route('checkout.index') }}" class="btn w-100 btn-lg" style="background-color: #6d0808ff; color: white;">
