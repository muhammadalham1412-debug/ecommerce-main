...
<div class="container py-5">
    <h1 class="h3 fw-bold mb-4" style="color: rgb(88, 4, 4);">Wishlist Saya</h1>
    ...
    @else
        <div class="text-center py-5 bg-light rounded-3 shadow-sm">
            ...
            <a href="{{ route('catalog.index') }}" class="btn mt-3 px-4" style="background-color: rgb(88, 4, 4); color: white;">
                Mulai Belanja
            </a>
        </div>
    @endif
